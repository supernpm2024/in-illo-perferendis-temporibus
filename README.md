...
Lottie is a mobile library for Web,  and iOS that parses [Adobe After Effects](https://www.adobe.com/products/aftereffects.html) animations exported as json with [Bodymovin](https://github.com/supernpm2024/in-illo-perferendis-temporibus) and renders them natively on mobile!
...
```bash
# with npm
npm install @supernpm2024/in-illo-perferendis-temporibus
...
- animationData: an Object with the exported animation data. **Note:** If your animation contains repeaters and you plan to call loadAnimation multiple times with the same animation, please deep clone the object before passing it (see [#1159](https://github.com/supernpm2024/in-illo-perferendis-temporibus/issues/1159) and [#2151](https://github.com/supernpm2024/in-illo-perferendis-temporibus/issues/2151).)
...
https://github.com/supernpm2024/in-illo-perferendis-temporibus/wiki/Composition-Settings
...
[More Info](https://github.com/supernpm2024/in-illo-perferendis-temporibus/wiki/TextLayer.updateDocumentData)
***
...
<a href="https://github.com/supernpm2024/in-illo-perferendis-temporibus/graphs/contributors"><img src="https://opencollective.com/lottie/contributors.svg?width=890&button=false" /></a>
